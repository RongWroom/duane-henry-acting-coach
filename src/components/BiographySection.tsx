...
export const BiographySection: React.FC = () => {
  return (
    <section id="biography" className="bg-[#f7f3ed] py-20 md:py-28 border-t border-[#DDD5C7]">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 md:px-14">
        ...
        <div className="flex items-center justify-between border-b border-[#DDD5C7] pb-4 mb-14 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#8C8275]">
          <div className="flex items-center gap-3">
            <span className="text-[#1A1715] font-mono">{BIOGRAPHY_DATA.sectionNumber}</span>
            <span className="w-8 h-[1px] bg-[#DDD5C7]" />
            <span className="text-[#1A1715]">{BIOGRAPHY_DATA.sectionTitle}</span>
          </div>
          <span className="text-[#8C8275]">{BIOGRAPHY_DATA.subtitle}</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col space-y-6">
            {/* Dusty Olive Block */}
            <div className="bg-[#5A5D4F] text-[#FDFCF7] p-8 sm:p-10 flex flex-col justify-between shadow-md relative overflow-hidden">
              {/* Giant quote glyph decorative watermark */}
              <div
                className="font-serif text-[72px] sm:text-[84px] leading-none text-[#DDD5C7]/30 select-none mb-2"
                aria-hidden="true"
              >
                “
              </div>
              ...
              {/* Pull Quote */}
              <blockquote className="font-serif italic text-[22px] sm:text-[25px] leading-[1.45] text-[#FDFCF7] mb-8 font-light">
                &ldquo;{BIOGRAPHY_DATA.quote}&rdquo;
              </blockquote>

              {/* Quote Attribution */}
              <div className="pt-6 border-t border-[#FDFCF7]/20 flex items-center justify-between text-[11px] tracking-[0.16em] uppercase">
                <span className="font-semibold text-[#FDFCF7]">{BIOGRAPHY_DATA.author}</span>
                <span className="text-[#DDD5C7]/80 text-[10px] font-light">
            ...
            <div className="bg-[#f1ede7] border border-[#DDD5C7] grid grid-cols-3 divide-x divide-[#DDD5C7] p-4 sm:p-6 text-center">
              {BIOGRAPHY_DATA.metrics.map((metric) => (
                <div key={metric.label} className="px-2 sm:px-3">
                  <div className="font-serif text-[26px] sm:text-[34px] font-normal text-[#1A1715] leading-none">
                    {metric.value}
                  </div>
                  <div className="mt-2 text-[9px] sm:text-[10px] font-semibold tracking-[0.15em] uppercase text-[#8C8275]">
                    {metric.label}
                  </div>
                </div>
              ))}
          ...
          <div className="lg:col-span-7 flex flex-col justify-between lg:pl-6">
            <div>
              ...
              {/* Headline */}
              <h2 className="font-serif text-[32px] sm:text-[44px] lg:text-[48px] leading-[1.15] tracking-[-0.01em] text-[#1A1715] mb-8">
                {BIOGRAPHY_DATA.heading}
              </h2>

              {/* Editorial Prose */}
              <div className="space-y-6 text-[16px] leading-[1.8] font-light text-[#1A1715]/85">
                <p>
                ...
                <p>
                  ...
                  Officer <strong className="font-medium text-[#1A1715]">Clayton Reeves</strong> on
            ...
            <div className="mt-10 pt-8 border-t border-[#DDD5C7] flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-[#1A1715] text-[#FDFCF7] flex items-center justify-center flex-shrink-0">
                <ShieldCheck className="w-5 h-5 text-[#DDD5C7]" />
              </div>
              <div>
                <div className="font-serif italic text-[22px] tracking-wide text-[#1A1715] leading-none">
                  Duane Henry
                </div>
                <div className="text-[10px] font-semibold tracking-[0.2em] uppercase text-[#8C8275] mt-1">
