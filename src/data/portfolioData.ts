...
export const HERO_DATA = {
  ...
  portraitUrl: "/images/duanehenry-937.avif",
...
export const SELECTED_WORKS_DATA = {
  ...
  credits: [
    ...
    },
    {
      ...
      details: "Drama across two seasons of the pioneering interactive Channel 4 series.",
    ...
    },
    {
      ...
      category: "FEATURE FILM",
      title: "Comedown",
      details: 'Colin "Col" alongside Jacob Anderson and Adam Deacon.',
    ...
    },
    {
      ...
      category: "FEATURE FILM",
      title: "W.E.",
      details: "Played Dwayne in historical romantic drama directed by Madonna.",
...
export const COACHING_DATA = {
  ...
  modules: [
    ...
    },
    {
      id: "career-path",
      number: "03",
      title: "Career & Industry Strategy",
      description:
        "One-on-one strategic mentorship on character preparation, script navigation, transitioning between the UK and US markets, and building professional longevity.",
      focusAreas: ["US & UK Market Nuance", "Representation & Pitch", "Career Longevity"],
